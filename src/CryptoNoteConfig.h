...
const char     CRYPTONOTE_NAME[]                             = "ryzncoin";
...
const int      P2P_DEFAULT_PORT                              = 42200;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 42300;
...
const std::initializer_list<const char*> SEED_NODES = {
  "seeder1.ryzncoin.org:42200",
  "seeder2.ryzncoin.org:42200",
};
